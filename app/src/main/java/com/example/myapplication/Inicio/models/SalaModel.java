...
public class SalaModel {
        ...
        String nmaxutentes;
        String alocacaodiaria;
        String alocacaomaxima;

        public SalaModel (int idsala, String nome, String duracaolimpeza, String nmaxutentes, String alocacaodiaria, String alocacaomaxima) {

            this.idsala = idsala;
            this.nome = nome;
            this.duracaolimpeza = duracaolimpeza;
            this.nmaxutentes = nmaxutentes;
            this.alocacaodiaria = alocacaodiaria;
        ...
        public String getAlocacaodiaria() { return alocacaodiaria; }
        public void setAlocacaodiaria(String alocacaodiaria) { this.alocacaodiaria = alocacaodiaria; }
